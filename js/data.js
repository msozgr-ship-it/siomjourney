  ...
  movies: [
    {
      ...
      poster: 'assets/posters/hoppers_poster.png',
      trailer: 'https://www.youtube.com/embed/xXMDQVOCXmE?autoplay=1&mute=1&controls=0&loop=1&playlist=xXMDQVOCXmE',
      file: 'https://www.youtube.com/embed/xXMDQVOCXmE?autoplay=1&rel=0&modestbranding=1',
      isYoutube: true,
      year: '2026',
      match: '95%',
      meta: 'HD'
